initHaTeMiLeForBrowser = function() {
    try {
        var configure = new hatemileforbrowser.hatemile.util
                .Configure({'prefix-generated-ids': 'id-cs-hatemile-firefox-'
                + Math.random().toString(36).substring(7)});
        var htmlParser = new hatemileforbrowser.hatemile.util.html.vanilla
                .VanillaHTMLDOMParser(document);

        var accessibleEvent = new hatemileforbrowser.hatemile.implementation
        ...
        var accessibleForm = new hatemileforbrowser.hatemile.implementation
