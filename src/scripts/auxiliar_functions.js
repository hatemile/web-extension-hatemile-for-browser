...
function setSimpleAttributes(configuration, userPreferences) {
    ...
    var attributes = [
        ...
        'aria-dropeffect-execute', 'aria-dropeffect-popup', 'aria-grabbed-true',
        'aria-grabbed-false', 'aria-haspopup-true', 'aria-level-prefix',
        'aria-level-suffix', 'aria-required-true', 'attribute-title-prefix',
...
function setSimpleUserPreferences(keys) {
    ...
    var attributes = [
        ...
        'aria-dropeffect-execute', 'aria-dropeffect-popup', 'aria-grabbed-true',
        'aria-grabbed-false', 'aria-haspopup-true', 'aria-level-prefix',
        'aria-level-suffix', 'aria-required-true', 'aria-value-maximum-prefix',
