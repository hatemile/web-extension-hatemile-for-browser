...
function getConfiguration(callback) {
	chrome.storage.sync.get({
		'prefix-generated-ids': 'id-hatemile-browser-' + Math.random().toString(36).substring(7),
		'aria-autocomplete-both-before': chrome.i18n.getMessage('extensions_hatemile_aria_autocomplete_both_before'),
		'aria-autocomplete-both-after': chrome.i18n.getMessage('extensions_hatemile_aria_autocomplete_both_after'),
		'aria-autocomplete-inline-before': chrome.i18n.getMessage('extensions_hatemile_aria_autocomplete_inline_before'),
		'aria-autocomplete-inline-after': chrome.i18n.getMessage('extensions_hatemile_aria_autocomplete_inline_after'),
		'aria-autocomplete-list-before': chrome.i18n.getMessage('extensions_hatemile_aria_autocomplete_list_before'),
		'aria-autocomplete-list-after': chrome.i18n.getMessage('extensions_hatemile_aria_autocomplete_list_after'),
		'aria-busy-true-before': chrome.i18n.getMessage('extensions_hatemile_aria_busy_true_before'),
		'aria-busy-true-after': chrome.i18n.getMessage('extensions_hatemile_aria_busy_true_after'),
		'aria-checked-true-before': chrome.i18n.getMessage('extensions_hatemile_aria_checked_true_before'),
		'aria-checked-true-after': chrome.i18n.getMessage('extensions_hatemile_aria_checked_true_after'),
		'aria-checked-false-before': chrome.i18n.getMessage('extensions_hatemile_aria_checked_false_before'),
		'aria-checked-false-after': chrome.i18n.getMessage('extensions_hatemile_aria_checked_false_after'),
		'aria-checked-mixed-before': chrome.i18n.getMessage('extensions_hatemile_aria_checked_mixed_before'),
		'aria-checked-mixed-after': chrome.i18n.getMessage('extensions_hatemile_aria_checked_mixed_after'),
		...
		'aria-expanded-true-before': chrome.i18n.getMessage('extensions_hatemile_aria_expanded_true_before'),
		'aria-expanded-true-after': chrome.i18n.getMessage('extensions_hatemile_aria_expanded_true_after'),
		'aria-expanded-false-before': chrome.i18n.getMessage('extensions_hatemile_aria_expanded_false_before'),
		'aria-expanded-false-after': chrome.i18n.getMessage('extensions_hatemile_aria_expanded_false_after'),
		...
		'aria-haspopup-true-before': chrome.i18n.getMessage('extensions_hatemile_aria_haspopup_true_before'),
		'aria-haspopup-true-after': chrome.i18n.getMessage('extensions_hatemile_aria_haspopup_true_after'),
		'aria-invalid-true-before': chrome.i18n.getMessage('extensions_hatemile_aria_invalid_true_before'),
		'aria-invalid-true-after': chrome.i18n.getMessage('extensions_hatemile_aria_invalid_true_after'),
		...
		'aria-level-prefix-before': chrome.i18n.getMessage('extensions_hatemile_aria_level_prefix_before'),
		'aria-level-suffix-before': chrome.i18n.getMessage('extensions_hatemile_aria_level_suffix_before'),
		'aria-level-prefix-after': chrome.i18n.getMessage('extensions_hatemile_aria_level_prefix_after'),
		'aria-level-suffix-after': chrome.i18n.getMessage('extensions_hatemile_aria_level_suffix_after'),
		'aria-orientation-vertical-before': chrome.i18n.getMessage('extensions_hatemile_aria_orientation_vertical_before'),
		'aria-orientation-vertical-after': chrome.i18n.getMessage('extensions_hatemile_aria_orientation_vertical_after'),
		'aria-orientation-horizontal-before': chrome.i18n.getMessage('extensions_hatemile_aria_orientation_horizontal_before'),
		'aria-orientation-horizontal-after': chrome.i18n.getMessage('extensions_hatemile_aria_orientation_horizontal_after'),
		'aria-pressed-true-before': chrome.i18n.getMessage('extensions_hatemile_aria_pressed_true_before'),
		'aria-pressed-true-after': chrome.i18n.getMessage('extensions_hatemile_aria_pressed_true_after'),
		'aria-pressed-false-before': chrome.i18n.getMessage('extensions_hatemile_aria_pressed_false_before'),
		'aria-pressed-false-after': chrome.i18n.getMessage('extensions_hatemile_aria_pressed_false_after'),
		'aria-pressed-mixed-before': chrome.i18n.getMessage('extensions_hatemile_aria_pressed_mixed_before'),
		'aria-pressed-mixed-after': chrome.i18n.getMessage('extensions_hatemile_aria_pressed_mixed_after'),
		...
		'aria-selected-true-before': chrome.i18n.getMessage('extensions_hatemile_aria_selected_true_before'),
		'aria-selected-true-after': chrome.i18n.getMessage('extensions_hatemile_aria_selected_true_after'),
		'aria-selected-false-before': chrome.i18n.getMessage('extensions_hatemile_aria_selected_false_before'),
		'aria-selected-false-after': chrome.i18n.getMessage('extensions_hatemile_aria_selected_false_after'),
		'aria-sort-ascending-before': chrome.i18n.getMessage('extensions_hatemile_aria_sort_ascending_before'),
		'aria-sort-ascending-after': chrome.i18n.getMessage('extensions_hatemile_aria_sort_ascending_after'),
		'aria-sort-descending-before': chrome.i18n.getMessage('extensions_hatemile_aria_sort_descending_before'),
		'aria-sort-descending-after': chrome.i18n.getMessage('extensions_hatemile_aria_sort_descending_after'),
		'aria-sort-other-before': chrome.i18n.getMessage('extensions_hatemile_aria_sort_other_before'),
		'aria-sort-other-after': chrome.i18n.getMessage('extensions_hatemile_aria_sort_other_after'),
		...
		'attribute-accesskey-default': chrome.i18n.getMessage('extensions_hatemile_attribute_accesskey_default'),
		...
		'attribute-draggable-before': chrome.i18n.getMessage('extensions_hatemile_attribute_draggable_before'),
		'attribute-draggable-after': chrome.i18n.getMessage('extensions_hatemile_attribute_draggable_after'),
		'attribute-dropzone-copy-before': chrome.i18n.getMessage('extensions_hatemile_attribute_dropzone_copy_before'),
		'attribute-dropzone-copy-after': chrome.i18n.getMessage('extensions_hatemile_attribute_dropzone_copy_after'),
		'attribute-dropzone-move-before': chrome.i18n.getMessage('extensions_hatemile_attribute_dropzone_move_before'),
		'attribute-dropzone-move-after': chrome.i18n.getMessage('extensions_hatemile_attribute_dropzone_move_after'),
		'attribute-dropzone-link-before': chrome.i18n.getMessage('extensions_hatemile_attribute_dropzone_link_before'),
		'attribute-dropzone-link-after': chrome.i18n.getMessage('extensions_hatemile_attribute_dropzone_link_after'),
		...
		'attribute-language-prefix-before': chrome.i18n.getMessage('extensions_hatemile_attribute_language_prefix_before'),
		'attribute-language-suffix-before': chrome.i18n.getMessage('extensions_hatemile_attribute_language_suffix_before'),
		'attribute-language-prefix-after': chrome.i18n.getMessage('extensions_hatemile_attribute_language_prefix_after'),
		'attribute-language-suffix-after': chrome.i18n.getMessage('extensions_hatemile_attribute_language_suffix_after'),
		'attribute-role-prefix-before': chrome.i18n.getMessage('extensions_hatemile_attribute_role_prefix_before'),
		'attribute-role-suffix-before': chrome.i18n.getMessage('extensions_hatemile_attribute_role_suffix_before'),
		'attribute-role-prefix-after': chrome.i18n.getMessage('extensions_hatemile_attribute_role_prefix_after'),
		'attribute-role-suffix-after': chrome.i18n.getMessage('extensions_hatemile_attribute_role_suffix_after'),
		'attribute-headers-prefix-before': chrome.i18n.getMessage('extensions_hatemile_attribute_headers_prefix_before'),
		'attribute-headers-suffix-before': chrome.i18n.getMessage('extensions_hatemile_attribute_headers_suffix_before'),
		'attribute-headers-prefix-after': chrome.i18n.getMessage('extensions_hatemile_attribute_headers_prefix_after'),
		'attribute-headers-suffix-after': chrome.i18n.getMessage('extensions_hatemile_attribute_headers_suffix_after'),
